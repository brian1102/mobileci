...
-(void)viewDidLoad
{
    ...
    [self loadChatView];
    self.placeHolderTxt = NSLocalizedStringWithDefaultValue(@"placeHolderText", nil, [NSBundle mainBundle], @"Type something", @"");
    ...
    // Hau Vo: customize chat screen
    [self.typingMessageView.layer setCornerRadius:10.0f];
    [self.sendMessageTextView setTextColor:[UIColor whiteColor]];
    self.sendMessageTextView.textContainerInset = UIEdgeInsetsMake(0, 0, 0, 0);
}
