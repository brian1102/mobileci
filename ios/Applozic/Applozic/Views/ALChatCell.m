...
-(instancetype)populateCell:(ALMessage*) alMessage viewSize:(CGSize)viewSize
{
    ...
    else if ([alMessage.type isEqualToString:@MT_INBOX_CONSTANT])
    {
        ...
        self.mBubleImageView.frame = CGRectMake(self.mUserProfileImageView.frame.size.width + 13,
                                                ...
                                                theTextSize.height + BUBBLE_PADDING_HEIGHT * 2);

        self.mBubleImageView.layer.shadowOpacity = 0.3;
        self.mBubleImageView.layer.shadowOffset = CGSizeMake(0, 2);
        self.mBubleImageView.layer.shadowRadius = 1;
        self.mBubleImageView.layer.masksToBounds = NO;
        // end make custom border radius
        ...
        if([alMessage getGroupId])
        {
            ...
            self.mBubleImageView.frame = CGRectMake(self.mUserProfileImageView.frame.size.width + BUBBLE_PADDING_X, 0,
                                                    ...
                                                    theTextSize.height + BUBBLE_PADDING_HEIGHT_GRP + 5);
            ...
            // make custom border radius
            UIBezierPath *bubbleLayerPath = [UIBezierPath
                                             bezierPathWithRoundedRect: self.mBubleImageView.bounds
                                             byRoundingCorners:(UIRectCornerTopRight | UIRectCornerTopLeft | UIRectCornerBottomRight)
                                             cornerRadii:CGSizeMake(15, 15)
                                             ];
            
            CAShapeLayer *bubbleLayerMask = [CAShapeLayer layer];
            
            bubbleLayerMask.frame = self.mBubleImageView.bounds;
            bubbleLayerMask.path = bubbleLayerPath.CGPath;
            self.mBubleImageView.layer.mask = bubbleLayerMask;
    ...
    else    //Sent Message
    {
        ...
        UIBezierPath *bubbleLayerPath = [UIBezierPath
                                         bezierPathWithRoundedRect: self.mBubleImageView.bounds
                                         byRoundingCorners:(UIRectCornerTopRight | UIRectCornerTopLeft | UIRectCornerBottomLeft)
                                         cornerRadii:CGSizeMake(15, 15)
                                         ];
