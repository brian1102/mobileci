...
abstract public class MobiComConversationFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String statusBarColor = ApplozicSetting.getInstance(getActivity()).getStatusBarColor();
        Log.e("MobicomConversation", "STATUS bar color: " + statusBarColor);
        ((ConversationActivity) getActivity()).getSupportActionBar().setBackgroundDrawable(new ColorDrawable(Color.parseColor(statusBarColor)));
    ...
    public void onResume() {
        ...
        swipeLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            public void onRefresh() {
                ...
                AsyncTaskCompat.executeParallel(downloadConversation);
                ((ConversationActivity) MobiComConversationFragment.this.getActivity()).refresh();
            }
        });
        if (channel != null) {
            updateChannelTitle();
